...
namespace Vulcano.Engine.Carga {
	public class CargadorFichasExcel : ICargadorFichas {
		public string Filename { get; set; }

		public CargadorFichasExcel(string filename) {
			Filename = filename;
		}

		public IList<FichaIndicadores> CargarFichas() {
			var book = SpreadsheetFactory.GetWorkbook(Filename);
